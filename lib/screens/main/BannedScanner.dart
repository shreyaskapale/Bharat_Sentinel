...
List foundIssues = [];
List pkgsF;
class BannedAppScanner extends StatefulWidget {

  static const route = "BannedScanner";


  @override
  _BannedAppScannerState createState() => _BannedAppScannerState();
}
...
class _BannedAppScannerState extends State<BannedAppScanner> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Banned App Scanner",style: TextStyle(color: Color(0xFFF2F3F1)),),
        backgroundColor: Color(0xFF505050),
      ),
      body: Center(
        child: FutureBuilder(
          future: basicVirusPackageScan("res"),
                  ...
                  Card(child: Container(
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage("assets/images/tricolorbanner.png"), fit: BoxFit.cover)),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text("Banned apps in accordance with Indian Government",style: TextStyle(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text("Total Issues Found ",style: TextStyle(
                              color: Colors.black
                            ),),
                            Container(
                              height: 25,
